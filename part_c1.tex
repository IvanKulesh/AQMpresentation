    ...
    \begin{equation*}
      \begin{gathered}
        \begin{cases} \textbf{k}, \sigma = \textbf{m}, \sigma'\\
          \textbf{l}, \sigma' = \textbf{n}, \sigma \\
          \textbf{k}, \sigma \neq \textbf{l}, \sigma' \end{cases}
          \qquad
          \begin{cases}   \textbf{k}, \sigma = \textbf{n}, \sigma\\
          \textbf{l}, \sigma' = \textbf{m}, \sigma' \\
          \textbf{k}, \sigma \neq \textbf{l}, \sigma' \end{cases}
      \end{gathered}
    \end{equation*}
  \end{block}
...
\begin{frame}[t]{Density for different spin}
  ...
  \begin{equation*}
    \begin{gathered}
      ...
      \bra{g} \hat{c}_{\veck,\sigma}^{\dagger} \hat{c}_{\textbf{k},\sigma}
      \hat{c}_{\textbf{l},\sigma'}^\dagger \hat{c}_{\textbf{l},\sigma'} \ket{g} -\\
      - \delta_{\sigma, \sigma'}\frac{1}{\V^2}\sum_{\veck}\bra{g} \hat{c}_{\veck,\sigma}^{\dagger} \hat{c}_{\textbf{k},\sigma}
      \hat{c}_{\textbf{k},\sigma'}^\dagger \hat{c}_{\textbf{k},\sigma'} \ket{g}
    \end{gathered}
  \end{equation*}
  }
...
\vspace{0.6cm}
 ...
 \begin{equation*}
   \sigma = \sigma' \implies \begin{cases}   \textbf{k} = \textbf{n}\\
     ...
     \textbf{l} = \textbf{n} \end{cases} \quad \text{and} \quad \textbf{k} \neq \textbf{l}
 \end{equation*}
  ...
  \begin{equation*}
    \begin{gathered}
      ...
      \bra{g}\hat{c}_{\veck,\sigma}^{\dagger} \hat{c}_{\textbf{k},\sigma}
      \hat{c}_{\veck,\sigma}^{\dagger} \hat{c}_{\textbf{k},\sigma}\ket{g}
      e^{-i\veck\cdot\x}e^{i\veck\cdot\x'}e^{i\textbf{k}\cdot\x}e^{-i\textbf{k}\cdot\x'}
    \end{gathered}
  \end{equation*}
  }
